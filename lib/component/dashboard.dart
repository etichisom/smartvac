  ...
  return   Column(
    children: [
      ...
      Container(
        ...
        child: Row(
          children: [
            box('Recent\nUpdates','body','pay now',(){},Color.fromRGBO(53, 75, 133, 0.77)),
            SizedBox(width: 15,),
            box('Weekly\nReadings','body','pay now',(){},Color.fromRGBO(255, 255, 255, 1)),
          ],
        ),
      ),
    ],
             ...
             child: Padding(
               ...
               child: Column(
                 ...
                 children: [
                   ...
                   Container(
                     height: 40,
                       child:d('Discover a detailed view of your weekly energy consumption.', color==c?Colors.black:Colors.white70)),
                   SizedBox(),
                   Row(
...
Widget d(String s,Color colors){
  return Text(s,style: GoogleFonts.poppins(fontSize: 9,fontWeight: FontWeight.w400,color:colors),);
}
